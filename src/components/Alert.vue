...
export default {
  ...
  computed: {
    computedClasses() {
      ...
      const styleClasses = {
        default: {
          bgClass: this.isDark ? 'bg-gray-800' : 'bg-blue-50',
          textClass: this.isDark ? 'text-blue-400' : 'text-blue-800',
          borderClass: this.bordered ? 'border ' + (this.isDark ? 'border-blue-400' : 'border-blue-800') : '',
        },
        sky: {
          bgClass: this.isDark ? 'bg-gray-800' : 'bg-sky-50',
          textClass: this.isDark ? 'text-sky-400' : 'text-sky-800',
          borderClass: this.bordered ? 'border ' + (this.isDark ? 'border-sky-400' : 'border-sky-800') : '',
        },
        cyan: {
          bgClass: this.isDark ? 'bg-gray-800' : 'bg-cyan-50',
          textClass: this.isDark ? 'text-cyan-400' : 'text-cyan-800',
          borderClass: this.bordered ? 'border ' + (this.isDark ? 'border-cyan-400' : 'border-cyan-800') : '',
        },
        teal: {
          bgClass: this.isDark ? 'bg-gray-800' : 'bg-teal-50',
          textClass: this.isDark ? 'text-teal-400' : 'text-teal-800',
          borderClass: this.bordered ? 'border ' + (this.isDark ? 'border-teal-400' : 'border-teal-800') : '',
        }
      };
